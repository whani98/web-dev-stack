...
/*DEPT_NO, GRADE_NO*/
ALTER TABLE USER_INFO FOREIGN KEY (DEPT_NO) REFERENCES DEPARTMENT (DEPT_NO);
ALTER TABLE USER_INFO ADD
FOREIGN(GRADE_NO) REFERENCES GRADE_NO;
...
CREATE TABLE USER_INFO (
 ...
 HIRE_DATE DATE DEFAULT (CURRENT_DATE),
 QUIT_DATE DATE,
 DEPT_NO VARCHAR(10) DEPARTMENT(DEPT_ID),
 GRADE_NO INT REFERENCES GRADE(GRADE_NO),
 SALARY INT
);
CREATE TABLE DEPARTMENT (
DEPT_ID VARCHAR(10) PRIMARY KEY AUTO_INCREMENT,
DEPT_NAME VARCHAR(100) NOT NULL,
LOCATION_CODE VARCHAR(10) REFERENCES LOCATION(LOCAL_ID)
);
CREATE TABLE LOCATION (
LOCAL_ID VARCHAR(10) PRIMARY KEY NOT NULL,
LOCAL_NAME VARCHAR(100) NOT NULL, 
NATIONAL_CODE VARCHAR(10) REFERENCES NATIONAL(NATIONAL_ID)
);
CREATE TABLE NATIONAL (
NATIONAL_ID VARCHAR(10) PRIMARY KEY NOT NULL,
